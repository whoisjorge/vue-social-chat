...
/* template */
var __vue_render__ = function (_h,_vm) {var _c=_vm._c;return _c('ul',{staticClass:"vsc-popup-body__list"},_vm._l((_vm.props.attendants),function(attendant,index){return _c('li',{key:("vsc-item-" + index),staticClass:"vsc-popup-body__list-item"},[_c('a',{staticClass:"vsc-popup-body__link",attrs:{"href":attendant.href,"rel":"noopener noreferer","target":"_blank","aria-label":("Contact " + (attendant.name) + ", opens in a new window")}},[_c('div',{staticClass:"vsc-popup-body__link-avatar"},[_c('img',{attrs:{"src":attendant.avatar.src,"alt":attendant.avatar.alt}}),_vm._v(" "),_c('span',{staticClass:"vsc-popup-body__link-avatar-brand",style:(attendant.app ? ("background-image: url(" + (_vm.props.urlAssets) + "/" + (attendant.app) + ".png)") : '')})]),_vm._v(" "),_c('div',{staticClass:"vsc-popup-body__link-info"},[_c('span',{staticClass:"vsc-popup-body__link-info__label",domProps:{"textContent":_vm._s(attendant.label)}}),_vm._v(" "),_c('span',{staticClass:"vsc-popup-body__link-info__name",domProps:{"textContent":_vm._s(attendant.name)}})])])])}),0)};
